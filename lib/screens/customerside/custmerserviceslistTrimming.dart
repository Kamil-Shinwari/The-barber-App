...
class CustmerServicesListTrimming extends StatefulWidget {
  CustmerServicesListTrimming({Key? key}) : super(key: key);

  @override
  State<CustmerServicesListTrimming> createState() =>
      _CustmerServicesListTrimmingState();
}

class _CustmerServicesListTrimmingState
    extends State<CustmerServicesListTrimming> {
  @override
          ...
          child: StreamBuilder(
            stream:
                FirebaseFirestore.instance.collection("services")
                                .where('rolehair', isEqualTo: 'trimming')
.snapshots(),
